...
namespace ARSoft.Tools.Net
{
    ...
    public static class BaseEncoding
    {
        ...
        public static byte[] FromBase16String(this string inData) =>
            inData.ToCharArray().FromBase16CharArray(0, inData.Length);
        ...
        public static byte[] FromBase32String(this string inData) =>
            inData.ToCharArray().FromBase32CharArray(0, inData.Length);
        ...
        public static byte[] FromBase32CharArray(this char[] inData, int offset, int length) =>
            inData.FromBase32CharArray(offset, length, _base32ReverseAlphabet);
        ...
        public static string ToBase32String(this byte[] inArray, int offset, int length) =>
            inArray.ToBase32String(offset, length, _base32Alphabet);
        ...
        public static byte[] FromBase32HexString(this string inData) =>
            inData.ToCharArray().FromBase32HexCharArray(0, inData.Length);
        ...
        public static byte[] FromBase32HexCharArray(this char[] inData, int offset, int length) =>
            inData.FromBase32CharArray(offset, length, _base32HexReverseAlphabet);
        ...
        public static string ToBase32HexString(this byte[] inArray, int offset, int length) =>
            inArray.ToBase32String(offset, length, _base32HexAlphabet);

        private static byte[] FromBase32CharArray(this IReadOnlyList<char> inData, int offset, int length,
        ...
        public static byte[] FromBase64String(this string inData) =>
            inData.ToCharArray().FromBase64CharArray(0, inData.Length);
        ...
        public static byte[] FromBase64CharArray(this char[] inData, int offset, int length) =>
            inData.FromBase64CharArray(offset, length, _base64ReverseAlphabet);
        ...
        public static byte[] FromBase64UrlString(this string inData) =>
            inData.ToCharArray().FromBase64UrlCharArray(0, inData.Length);
        ...
        public static byte[] FromBase64UrlCharArray(this char[] inData, int offset, int length) =>
            inData.FromBase64CharArray(offset, length, _base64UrlReverseAlphabet);
        ...
        public static string ToBase64UrlString(this byte[] inArray, int offset, int length) =>
            inArray.ToBase64String(offset, length, _base64UrlAlphabet);

        private static byte[] FromBase64CharArray(this char[] inData, int offset, int length,
