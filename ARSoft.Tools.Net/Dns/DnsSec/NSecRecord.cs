...
namespace ARSoft.Tools.Net.Dns.DnsSec
{
    ...
    public class NSecRecord : DnsRecordBase
    {
        ...
        public NSecRecord(DomainName name, RecordClass recordClass, int timeToLive, DomainName nextDomainName,
        ...
        {
            DnsMessageBase.EncodeDomainName(messageData, offset, ref currentPosition, NextDomainName, null,
                useCanonical);
