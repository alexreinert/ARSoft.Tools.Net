...
namespace ARSoft.Tools.Net.Dns.DnsSec
{
    ...
    public abstract class KeyRecordBase : DnsRecordBase
    {
        ...
        protected KeyRecordBase(DomainName name, RecordClass recordClass, int timeToLive, ushort flags,
            ProtocolType protocol, DnsSecAlgorithm algorithm)
        ...
        protected internal sealed override void EncodeRecordData(byte[] messageData, int offset,
            ref int currentPosition, Dictionary<DomainName, ushort> domainNames, bool useCanonical)
        {
        ...
        protected abstract void EncodePublicKey(byte[] messageData, int offset, ref int currentPosition,
