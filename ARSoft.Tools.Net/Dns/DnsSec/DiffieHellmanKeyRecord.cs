...
namespace ARSoft.Tools.Net.Dns.DnsSec
{
    ...
    public class DiffieHellmanKeyRecord : KeyRecordBase
    {
        ...
        public DiffieHellmanKeyRecord(DomainName name, RecordClass recordClass, int timeToLive, ushort flags,
            ProtocolType protocol, byte[] prime, byte[] generator, byte[] publicValue)
