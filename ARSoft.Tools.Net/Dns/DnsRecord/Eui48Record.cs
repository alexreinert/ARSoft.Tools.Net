...
namespace ARSoft.Tools.Net.Dns
{
	...
	public class Eui48Record : DnsRecordBase
	{
		...
		internal Eui48Record(DomainName name, RecordType recordType, RecordClass recordClass, int timeToLive, IList<byte> resultData, int currentPosition, int length)
