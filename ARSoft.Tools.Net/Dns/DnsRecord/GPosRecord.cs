...
namespace ARSoft.Tools.Net.Dns.DnsRecord
{
    ...
    public class GPosRecord : DnsRecordBase
    {
        ...
        protected internal override int MaximumRecordDataLength =>
            3 + Longitude.ToString(CultureInfo.InvariantCulture).Length +
        ...
        {
            Longitude = double.Parse(DnsMessageBase.ParseText(resultData, ref currentPosition),
                CultureInfo.InvariantCulture);
            Latitude = double.Parse(DnsMessageBase.ParseText(resultData, ref currentPosition),
                CultureInfo.InvariantCulture);
            Altitude = double.Parse(DnsMessageBase.ParseText(resultData, ref currentPosition),
                CultureInfo.InvariantCulture);
        }
