...
namespace ARSoft.Tools.Net.Dns.DnsRecord
{
    ...
    public class TKeyRecord : DnsRecordBase
    {
        ...
        public TKeyRecord(DomainName name, TSigAlgorithm algorithm, DateTime inception, DateTime expiration,
            TKeyMode mode, ReturnCode error, byte[] key, byte[] otherData)
        ...
        protected internal override int MaximumRecordDataLength =>
            18 + TSigAlgorithmHelper.GetDomainName(Algorithm).MaximumRecordDataLength + Key.Length + OtherData.Length;
