...
namespace ARSoft.Tools.Net.Dns.Resolver
{
    ...
    public static class DnsSecResolverExtensions
    {
        ...
        public static DnsSecResult<T> ResolveSecure<T>(this IDnsSecResolver resolver, string name,
        ...
        public static Task<DnsSecResult<T>> ResolveSecureAsync<T>(this IDnsSecResolver resolver, string name,
            RecordType recordType = RecordType.A, RecordClass recordClass = RecordClass.INet,
