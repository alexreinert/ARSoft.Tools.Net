...
namespace ARSoft.Tools.Net.Dns.EDns
{
    ...
    public class LongLivedQueryOption : EDnsOptionBase
    {
        ...
        public LongLivedQueryOption(LlqOperationCode operationCode, LlqErrorCode errorCode, ulong id,
            TimeSpan leaseTime)
        ...
        /// <param name="id"> Identifier for an LLQ </param>
        /// <param name="leaseTime"> Requested or granted life of LLQ </param>
        public LongLivedQueryOption(ushort version, LlqOperationCode operationCode, LlqErrorCode errorCode, ulong id,
            TimeSpan leaseTime)
            : this()
        {
            Version = version;
